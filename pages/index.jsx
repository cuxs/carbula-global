...
const Home = ({ zonas, referer, COUNTRY_CODE }) => {
  ...
  const getSomosText = () => {
    const texts = {
      ar: <Fragment>SOMOS UNA STARTUP POTENCIADA POR <a target="__blank" rel="noreferrer" href="https://embarca.tech">EMBARCA</a>,<a target="__blank" href="https://www.corfo.cl/sites/cpp/homecorfo">CORFO</a>, <a target="__blank" rel="noreferrer" href="https://www.startupchile.org">STARTUP CHILE</a> y <a target="__blank" rel="noreferrer" href="https://www.seedstars.com/funds/international/">SEEDSTARS</a> COMPROMETIDA <br /> EN REINVENTAR LA ANTIGUA Y ENGORROSA EXPERIENCIA A LA HORA DE VENDER O COMPRAR VEHÍCULOS.</Fragment>,
      cl: <Fragment>SOMOS UNA STARTUP POTENCIADA POR <a target="__blank" rel="noreferrer" href="https://www.startupchile.org/">STARTUP CHILE</a> COMPROMETIDA EN REINVENTAR LA ANTIGUA Y ENGORROSA EXPERIENCIA A LA HORA DE VENDER O COMPRAR VEHÍCULOS.</Fragment>,
      uy: <Fragment>SOMOS UNA STARTUP POTENCIADA POR <a target="__blank" rel="noreferrer" href="https://www.anii.org.uy/">ANII</a>, <a target="__blank" rel="noreferrer" href="https://www.startupchile.org">STARTUP CHILE</a> y <a target="__blank" rel="noreferrer" href="https://www.seedstars.com/funds/international/">SEEDSTARS</a> COMPROMETIDA EN REINVENTAR LA ANTIGUA Y ENGORROSA EXPERIENCIA A LA HORA DE VENDER O COMPRAR VEHÍCULOS.</Fragment>,
      mx: <Fragment>SOMOS UN MARKETPLACE POTENCIADO POR EMBARCA, CORFO, ANNI, <a target="__blank" rel="noreferrer" href="https://www.startupchile.org/">STARTUP CHILE</a>, <a target="__blank" rel="noreferrer" href="https://www.seedstars.com/funds/international/">SEEDSTARS INTERNATIONAL</a> Y ESTAMOS COMPROMETIDOS A REINVENTAR LA MANERA DE COMPRAR Y VENDER AUTOS EN EL MUNDO.</Fragment>
    }
