...
const Home = ({ zonas, referer, COUNTRY_CODE }) => {
  ...
  const getSomosText = () => {
    const texts = {
      ar: <Fragment>STARTUP POTENCIADA POR <br></br> <a target="__blank" rel="noopener noreferrer" href="https://embarca.tech"><img src={"/images/embarca-logo.png"}/></a>{""}<a target="__blank" href="https://www.corfo.cl/sites/cpp/homecorfo"><img src={"/images/corfo-logo.png"}/></a>{""}<a target="__blank" rel="noopener noreferrer" href="https://www.anii.org.uy/"><img src={"/images/anii-logo.png"}/></a>{""}<a target="__blank" rel="noopener noreferrer" href="https://www.startupchile.org"><img src={"/images/startup-chile-logo.png"}/></a>{""}<a target="__blank" rel="noopener noreferrer" href="https://www.seedstars.com/funds/international/"><img src={"/images/seedstars-logo.png"}/></a>{""}<a target="__blank" rel="noopener noreferrer" href="https://guil.cl/"><img src={"/images/guil-logo.png"}/></a></Fragment>,
