...
const BlackoutComponent = ({ overlayBackground }) => {
  ...
  return (<span className={styles[blackOutClasses]} id="blackout">
    <div className={styles.cargando__container}>
      <animated.img style={logoStyle} src="/images/logo.svg" alt="Carbula Autos"/>
      <div className={styles.loading__spinner}>
        <PuffLoader color="#00fbcd" css={`position: absolute; top: 1000px; left:50%; transform: translate(-50%)`} />
      </div>
