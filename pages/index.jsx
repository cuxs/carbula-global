...
const Home = ({ zonas, referer, COUNTRY_CODE }) => {
  ...
  const getSomosText = () => {
    const texts = {
      ar: <Fragment>STARTUP POTENCIADA POR <br></br> <a target="__blank" rel="noopener noreferrer" href="https://embarca.tech"><img src={"/images/embarca-logo.webp"}/></a>{""}<a target="__blank" href="https://www.corfo.cl/sites/cpp/homecorfo"><img src={"/images/corfo-logo.webp"}/></a>{""}<a target="__blank" rel="noopener noreferrer" href="https://www.anii.org.uy/"><img src={"/images/anii-logo.webp"}/></a>{""}<a target="__blank" rel="noopener noreferrer" href="https://www.startupchile.org"><img src={"/images/startup-chile-logo.webp"}/></a>{""}<a target="__blank" rel="noopener noreferrer" href="https://www.seedstars.com/funds/international/"><img src={"/images/seedstars-logo.webp"}/></a>{""}<a target="__blank" rel="noopener noreferrer" href="https://guil.cl/"><img src={"/images/guil-logo.webp"}/></a></Fragment>,
