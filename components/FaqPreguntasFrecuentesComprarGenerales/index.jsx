    ...
    <Accordion allowZeroExpanded className={styles.accordion}>
      <AccordionItem className={styles.accordion__item}>
        ...
        <AccordionItemPanel className={styles.accordion__panel}>
          <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
            <div itemprop="text">
              <ul><ol>1.Ingresa a nuestro <a href="https://catalogo.carbula.com/" target="__blank">catálogo de autos.</a></ol></ul>
            </div>
          </div>
          <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
            <div itemprop="text">
      ...
      <AccordionItem className={styles.accordion__item}>
        ...
        <AccordionItemPanel className={styles.accordion__panel}>
          <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
            <div itemprop="text">
              <ul><ol>1.Pagar con tarjeta de crédito de los bancos más importantes de tu país.</ol></ul>
            </div>
          </div>
          <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
            <div itemprop="text">
      ...
      <AccordionItem className={styles.accordion__item}>
        ...
        <AccordionItemPanel className={styles.accordion__panel}>
          <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
            <div itemprop="text">
              <ul><ol>1.Renta mínima mensual y líquida <a href="http://api.whatsapp.com/send?phone=${getWhatsappNumber(COUNTRY_CODE)}&text=Hola,%20tengo%20una%20consulta%20sobre%20los%20requisitos%20para%20acceder%20a%20financiamiento" target="__blank">(consultar con operador)</a></ol></ul>
            </div>
          </div>
          <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
            <div itemprop="text">
      ...
      <AccordionItem className={styles.accordion__item}>
        ...
        <AccordionItemPanel className={styles.accordion__panel}>
          ...
          <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
            <div itemprop="text">
              <ul><ol>2.Efectivo.</ol></ul>
            </div>
          </div>
          <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
            <div itemprop="text">
              <ul><ol>3.Tarjetas de crédito (trabajamos con los bancos más importantes de tu país).</ol></ul>
            </div>
          </div>
          <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
            <div itemprop="text">
              <ul><ol>4.También aceptamos autos como parte de pago.</ol></ul>
            </div>
          </div>
        </AccordionItemPanel>
      ...
      <AccordionItem className={styles.accordion__item}>
        ...
        <p>Lo es, ya que garantizamos:</p>
          ...
          <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
            <div itemprop="text">
              <ul><ol>4.Transacciones 100% confiables.</ol></ul>
            </div>
          </div>
        </AccordionItemPanel>
